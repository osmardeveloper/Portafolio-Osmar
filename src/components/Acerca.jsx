    ...
    <div className='principal'>
      ...
      <div className="container-acerca">
        ...
        <div className='container-descripcion'>
           ...
           <h2 className="titulo">Desarrollador web <br></br> Full stack</h2>
        ...
        <a href="/hdv-osmar-fullStack.pdf" download="cv-osmar-fullStack" className='descripcion up'><i className='bx bx-cloud-download'></i> DescargarCV </a>
